                    ...
                    totalPizza !== 0 ?
                        <>
                            <div className="cart__top">
                                ...
                                <button onClick={() => dispatch(clearItems(items))} className="cart__clear">
                            ...
                            <div className="content__items">
                                {
                                    items.map(object => <CartItem key={object.id} {...object}/>)
                                }
                            </div>
                            <div className="cart__bottom">
                                ...
                                <div className="cart__bottom-buttons">
                                    <NavLink to="/react-pizza-shop" className="button button--outline button--add go-back-btn">
