    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-count">
                <button onClick={onClickMinusPizza} className="button button--outline button--circle cart__item-count-minus">
            ...
            <div className="cart__item-remove">
                <button onClick={() => dispatch(removeItem(id))} className="button button--outline button--circle">
